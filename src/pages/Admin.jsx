...
const dashboard = () => {
  ...
  return (
    <div className="bg-primary h-full pb-8">
      <h1 className="font-bold text-[24px] pt-8 px-12">Hello Admin!</h1>

      <div className="flex flex-row flex-wrap gap-4 pt-8 px-12">
        <div className="">
          <Card
            text="Total Users"
            data={adminData?.totalUser}
            icon={
              <svg
...
<BlackCard/>
      ...
      <div className=" flex flex-col pt-8 px-12 gap-5">
        <Table2 name="Total Students" />
